...
package net.ypresto.miniguava.base;
...
public class JoinerTest extends TestCase {
  ...
  private static final List<Integer> ITERABLE_NULL_NULL
  ...
  private static final List<Integer> ITERABLE_FOUR_NULLS
  ...
  private static void checkNoOutput(Joiner joiner, List<Integer> set) {
