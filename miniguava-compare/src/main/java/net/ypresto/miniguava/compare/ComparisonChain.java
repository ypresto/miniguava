...
public abstract class ComparisonChain {
  ...
  private static final ComparisonChain ACTIVE =
      new ComparisonChain() {
        ...
        public ComparisonChain compare(int left, int right) {
          return classify(PrimitiveComparison.compareInts(left, right));
        }

        @Override
        public ComparisonChain compare(long left, long right) {
          return classify(PrimitiveComparison.compareLongs(left, right));
        }
        ...
        public ComparisonChain compareTrueFirst(boolean left, boolean right) {
          return classify(PrimitiveComparison.compareBooleans(right, left)); // reversed
        }

        @Override
        public ComparisonChain compareFalseFirst(boolean left, boolean right) {
          return classify(PrimitiveComparison.compareBooleans(left, right));
        }
  ...
  /**
   * Compares two {@code int} values as specified by
   * {@link PrimitiveComparison#compareInts(int, int)},
  ...
  /**
   * Compares two {@code long} values as specified by
   * {@link PrimitiveComparison#compareLongs(long, long)},
   * <i>if</i> the result of this comparison chain has not already been
   * determined.
   */
  ...
  /**
   * Compares two {@code float} values as specified by
   * {@link PrimitiveComparison#compareFloats(float, float)},
   * <i>if</i> the result of this comparison chain has not
   ...
   * {@link PrimitiveComparison#compareDoubles(double, double)},
   * <i>if</i> the result of this comparison chain has not
   * already been determined.
   */
