 ...
 *     such as {@code ImmutableMultiset#elementSet} iterate in the same order as the parent, except
 *     as noted.
...
public abstract class ImmutableCollection<E> extends AbstractCollection<E> implements Serializable {
   ...
   * @since 10.0
   */
  // miniguava: Changed visibility from public to protected.
  // miniguava: Added addAll(Collection) and removed addAll(Iterable) and addAll(Iterator).
  protected abstract static class Builder<E> {
  ...
  // miniguava: Added addAll(Collection) and removed addAll(Iterable).
  abstract static class ArrayBasedBuilder<E> extends ImmutableCollection.Builder<E> {
    Object[] contents;
    int size;

    ArrayBasedBuilder(int initialCapacity) {
      InternalUtils.checkNonnegative(initialCapacity, "initialCapacity");
