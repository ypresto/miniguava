...
import static net.ypresto.miniguava.collect.immutables.InternalUtils.checkEntryNotNull;
...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
   ...
   */
  // miniguava: Modified not to use ImmutableBiMap.
  ...
  public static class Builder<K, V> {
     ...
     */
    // miniguava: Modified not to use Ordering#onResultOf().
    ...
    @MiniGuavaSpecific
    private Comparator<ImmutableMapEntry<?, V>>mapValueComparator(final Comparator<? super V> valueComparator) {
      return new Comparator<ImmutableMapEntry<?, V>>() {
        @Override
        public int compare(ImmutableMapEntry<?, V> lhs, ImmutableMapEntry<?, V> rhs) {
          return valueComparator.compare(lhs.getValue(), rhs.getValue());
        }
      };
    }
  }
   ...
   * @throws NullPointerException if any key or value in {@code map} is null
   */
  // miniguava: Removed ImmutableSortedMap class check.
   ...
   * @since 19.0
   */
  // miniguava: Originally Iterable, modified to Collection.
  @Beta
  public static <K, V> ImmutableMap<K, V> copyOf(
      Collection<? extends Entry<? extends K, ? extends V>> entries) {
    @SuppressWarnings("unchecked") // we'll only be using getKey and getValue, which are covariant
    Entry<K, V>[] entryArray = (Entry<K, V>[]) entries.toArray(EMPTY_ENTRY_ARRAY);
  ...
  public boolean equals(@Nullable Object object) {
    return InternalUtils.mapsEqualsImpl(this, object);
  }
  ...
  @Override
  public int hashCode() {
    return InternalUtils.setsHashCodeImpl(entrySet());
  }
  ...
  public String toString() {
    return InternalUtils.mapsToStringImpl(this);
  }
