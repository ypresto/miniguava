...
import net.ypresto.miniguava.collect.immutables.ImmutableSet.Builder;
...
public class ImmutableSetTest extends AbstractImmutableSetTest {
  ...
  public void testCreation_allDuplicates() {
    ImmutableSet<String> set = ImmutableSet.copyOf(Arrays.asList("a", "a"));
    assertTrue(set instanceof SingletonImmutableSet);
    assertEquals(Collections.singletonList("a"), new ArrayList<String>(set));
  }
