...
import net.ypresto.miniguava.collect.immutables.ImmutableMap.Builder;
...
public class ImmutableMapTest extends TestCase {
  ...
  public static class CreationTests extends TestCase {
    ...
    // miniguava: removed Maps.immutableEntry() test.
  ...
  // miniguava: Removed multimap related tests.
