...
/**
 * Base class for {@link ImmutableSet} and  {@code ImmutableSortedSet} tests.
 *
...
public abstract class AbstractImmutableSetTest extends TestCase {
  ...
  // miniguava: Removed copyOf() methods which receive Iterable or Iterator
  ...
  public void testBuilderAddAllHandlesNullsCorrectly() {
    ImmutableSet.Builder<String> builder = this.<String>builder();
    try {
      // miniguava: originally Iterable<String>
      builder.addAll((List<String>) null);
      fail("expected NullPointerException");  // COV_NF_LINE
    } catch (NullPointerException expected) {
    }
