...
class ConsumingQueueIterator<T> extends AbstractIterator<T> {
  ...
  ConsumingQueueIterator(T... elements) {
    // miniguava: Use ArrayDeque instead of LinkedList, as GWT-compatibility is not necessary.
    // miniguava: original comment: Uses LinkedList because ArrayDeque isn't GWT-compatible for now =(
